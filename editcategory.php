            ...
            <div class="container-fluid">    
                ...
                <form method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control" style="width:50%" name="category" value="<?php echo $rows['Category'];?>">
                    </div>
                    <button type="submit" class="btn btn-success mt-3" name="editCategory">Update Category <i class="far fa-plus-square"></i></button>
